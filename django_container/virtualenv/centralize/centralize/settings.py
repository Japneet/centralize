...
STATIC_URL = '/static/'
STATICFILES_DIRS = [
    os.path.join(PROJECT_ROOT, 'centralize', 'static')
]
STATICFILES_FINDERS = [
...
context_processors = [
    ...
    'centralize.core.context_processors.default_currency',
    'centralize.core.context_processors.categories']
...
MIDDLEWARE_CLASSES = [
    ...
    'centralize.cart.middleware.CartMiddleware',
    'centralize.core.middleware.DiscountMiddleware',
    'centralize.core.middleware.GoogleAnalytics',
    'centralize.core.middleware.CountryMiddleware',
    'centralize.core.middleware.CurrencyMiddleware'
]
...
AUTHENTICATION_BACKENDS = (
    'centralize.registration.backends.EmailPasswordBackend',
    'centralize.registration.backends.ExternalLoginBackend',
    'centralize.registration.backends.TrivialBackend'
)
